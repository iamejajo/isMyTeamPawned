        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="hidden md:flex items-center space-x-6">
                    ...
                    <a href="{{ route('login') }}" class="text-teal-400 font-medium">Login</a>
            ...
            <div id="mobile-menu" class="hidden md:hidden">
                <div class="px-2 pt-2 pb-3 space-y-1 bg-black bg-opacity-95 border-t border-gray-800">
                    ...
                    <a href="{{ route('login') }}" class="text-teal-400 block px-3 py-2 text-base font-medium">Login</a>
            ...
            <div class="login-card rounded-xl p-8">
                <div class="text-center">
                    ...
                    <p class="text-gray-400">
                        Sign in to your TEAMPWNED account
                    </p>
                </div>
